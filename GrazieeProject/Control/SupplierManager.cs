...
namespace GrazieeProject.Control
{
    class SupplierManager
    {
       ...
       // private DataTable dataTable;
        ...
        public DataSet GetDataSupplierByName(string name)
        {
            dataSet = new DataSet();
            query = string.Empty;
            query = "SELECT * FROM supplier WHERE nama_supplier LIKE '%" + name + "%'";
        ...
        public DataSet GetDataSupplierComboBox()
        {
            dataSet = new DataSet();
            query = string.Empty;
        ...
        public string GetMaxIDSupp()
        {
            string result = String.Empty;

            query = string.Empty;
            query = "SELECT MAX(id_supplier) FROM supplier";
            ...
            {
                ex.Message.ToString();
                result = Utils.DEFAULT_ID_SUPPLIER;
            }
            catch (Exception exec)
            {
                exec.Message.ToString();
